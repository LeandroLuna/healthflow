...
const navbarLinks = [
  ...
  { label: "Solução", href: "/#solution", ariaLabel: "Solução" },
  { label: "Sobre nós", href: "/#about-us", ariaLabel: "Sobre nós" },
  { label: "Modelo de negócios", href: "/#business-model", ariaLabel: "Modelo de negócios" },
  { label: "Equipe", href: "/#team", ariaLabel: "Equipe" },
  { label: "Contato", href: "/#contact", ariaLabel: "Contato" },
